...
import mphozaJersey from '../images/mphoza.png'
import './About.css'
  ...
  return (
    <section id="about" className="about">
      <div className="about__bg" aria-hidden="true">
        <div className="about__bg-art"><img src={gamePageDesign} alt="" className="about__bg-image" /></div>
        <div className="about__logo-mark"><img src={wraftLogo} alt="" className="about__logo" /></div>
      </div>
      <div className="container about__grid">
        <Reveal className="about__content">
          ...
          <p className="about__lead">We are an esports organization rooted in the heart of ekasi, driven by a single mission: to transform local passion into professional greatness.</p>
          ...
          <p className="about__body">To discover, nurture, and elevate the next generation of competitive gaming talent. We provide young players from our communities with the structure, training, and exposure they need to compete at the highest levels.</p>
          <div className="about__what-we-do">
            <div className="about__what-we-do-copy">
