...
const PILLARS = [
  ...
  { title: 'Mentorship & Discipline', body: 'Esports requires focus, teamwork, and mental resilience. We guide our youth both in and out of the game.' },
  { title: 'Professional Pathways', body: 'We connect our players with competitive leagues, sponsorships, and networking opportunities to launch real esports careers.' },
  { title: 'Community Building', body: 'We are growing a safe, inclusive, and vibrant gaming culture right here at home.' },
]
      ...
      <div className="container about__content">
        <div className="about__intro-grid">
          <Reveal className="about__intro">
            ...
            <p className="about__lead">We are an esports organization from ekasi. We develop gaming culture, sharpen the skills of young players, and create pathways to professional esports.</p>
            <p className="about__body">We are an esports organization rooted in the heart of ekasi, driven by a single mission: to transform local passion into professional greatness. Gaming is more than just a hobby—it is a competitive frontier, a community builder, and a viable career path. We exist to bridge the gap between casual township gaming and the global esports stage.</p>
          </Reveal>
          <Reveal className="about__logo-wrap" delay={120}>
