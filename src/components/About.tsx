    ...
    <section id="about" className="about" style={{ ['--about-art' as string]: `url("${gamePageDesign}")` }}>
      <div className="container about__inner">
        ...
        <div className="about__content">
          <Reveal><p className="about__lead">Wraft is an esports organization rooted in the heart of ekasi, driven by a single mission: to transform local passion into professional greatness.</p><p className="about__body">Gaming is more than just a hobby—it is a competitive frontier, a community builder, and a viable career path. We exist to bridge the gap between casual township gaming and the global esports stage.</p></Reveal>
