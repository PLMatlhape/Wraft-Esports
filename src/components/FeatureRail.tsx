...
const FEATURES: FeatureItem[] = [
  {
    title: 'ARENA',
    description: 'Gear up, lock in, and dominate the ultimate multiplayer arena.',
  },
  {
    title: 'RESPAWN',
    description: 'Every end is a new beginning — jump back in stronger and faster.',
  },
  {
    title: 'LEVEL UP',
    description: 'Boost your loadout, earn rewards, and climb the ranks.',
  },
]
